...
<script runat="server">
    ...
    protected void srcEntry_Deleted(object sender, ObjectDataSourceStatusEventArgs e)
    {
        if (e.Exception == null)
            Response.Redirect("~/CodeSamples/Default.aspx");
    }

    protected void frmEntry_DataBound(object sender, EventArgs e)
    {
        this.Title = (string)DataBinder.Eval(frmEntry.DataItem, "Title");
    }
</script>
