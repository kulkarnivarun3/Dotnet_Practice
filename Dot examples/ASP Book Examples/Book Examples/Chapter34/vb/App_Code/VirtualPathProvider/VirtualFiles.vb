...
Namespace Superexpert
    ...
    Public Class VirtualFiles
        ...
        Public Shared Function GetCodeSampleId(ByVal virtualPath As String) As Integer
            Dim segments() As String = virtualPath.Split("/"c)
        ...
        Public Shared Function FileExists(ByVal virtualPath As String) As Boolean
            Dim codeSampleId As Integer = GetCodeSampleId(virtualPath)
        ...
        Public Shared Sub FileInsert(ByVal virtualPath As String, ByVal name As String, ByVal content As String)
            ...
            Dim cmd As SqlCommand = New SqlCommand(commandText, con)
        ...
        Public Shared Function DirectorySelectFiles(ByVal virtualPath As String) As List(Of SqlVirtualFile)
            ...
            ' Initialize command
            Dim con As SqlConnection = New SqlConnection(_connectionString)
            Dim commandText As String = "SELECT Path,Name FROM VirtualFiles WHERE Path=@Path ORDER BY Path"
        ...
        Public Shared Function DirectorySelectDirectories(ByVal virtualPath As String) As List(Of SqlVirtualDirectory)
            ...
            ' Initialize command
            Dim con As SqlConnection = New SqlConnection(_connectionString)
            Dim commandText As String = "SELECT Path FROM VirtualDirectories WHERE ParentPath=@Path ORDER BY Path"
            Dim cmd As SqlCommand = New SqlCommand(commandText, con)
