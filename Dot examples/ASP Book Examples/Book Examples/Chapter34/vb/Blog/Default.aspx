...
<script runat="server">
    ...
    Public Property BlogAuthorUserName() As String
        Get
            Return CType(ViewState("BlogAuthorUserName"), String)
        End Get
        Set(ByVal Value As String)
            ViewState("BlogAuthorUserName") = value
        End Set
    End Property
    ...
    Protected Sub srcBlog_Deleted(ByVal sender As Object, ByVal e As ObjectDataSourceStatusEventArgs)
        Response.Redirect("~/Default.aspx")
    End Sub
 
 
    Protected Sub frmBlog_DataBound(ByVal sender As Object, ByVal e As EventArgs)
        BlogAuthorUserName = (CType(frmBlog.DataItem, FullBlog)).AuthorUserName
    End Sub
 
    Private Function ShowAuthorCssClass(ByVal commentAuthorUserName As String) As String
        If String.Compare(commentAuthorUserName, BlogAuthorUserName, True) = 0 Then
...
<asp:ListView
    ...
    <ItemTemplate>
    <div class='divBlogComment <%# ShowAuthorCssClass(Eval("AuthorUserName")) %>'>
